...
use Datachin\XdcDatachainGateway\base\Core as BaseCore;
use Datachin\XdcDatachainGateway\rest\XdcDatachainApi;
use Datachin\XdcDatachainGateway\view\menu\Page;
use Datachin\XdcDatachainGateway\view\widget\Widget;
...
class Core extends BaseCore {
    ...
    public function init() {
        ...
        add_action('rest_api_init', [XdcDatachainApi::instance(), 'rest_api_init']);
 ...
 * See API docs.
 *
 * @api {get} /xdc-datachain-gateway/v1/plugin Get plugin information
